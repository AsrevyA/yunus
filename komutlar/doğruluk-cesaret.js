...
exports.run = async (bot, message, args) => {
  var dogruluk = [
    ...
    "En utanç duyduğun şey ?",
    "En Kötü Anın ne ?",
    "En sevmediğin kişi kim ?",
    "Geçmişte yaşadığın en kötü olay ?",
    "Sahil olduğunu en büyük ve kötü alışkanlık",
    "Seni en çok ne etkiler ",
    "Burnunu karıştırirmisin"
  ];
  var cesaret = [
    ...
    "Bir dakika boyunca birini taklit et",
    "Telefonda ki tarayıcı geçmişini ss alıp at",
    "Son zamanlarda nefret ettiğin veya sevdiğin kişi kim ?",
    "İnstagram veya wp de ki son mesaji oku",
    "Hayatının en büyük hatası ne?",
    "İşlediğini en büyük suç ?",
    "Çocukluğundan bir sırrını bize de paylaş",
    "Şimdiye kadar yaptığın en büyük şey?",
    "Hiç Birisini Öptünmü Dudaktan",
     "Hiç Kendine Sevgili Yaptın mı" 
  ];
