...
exports.run = async(client,message, args) => {
  ...
  if(!args[0])  return message.channel.send(new Discord.MessageEmbed().setColor('0x36393E').setDescription('> **Otorol sistemini ne yapmak istediğini belirtmedin**  \n> `%otorol ayarla @üye #kanal` **Otorol sistemini ayarlar.** \n> `%otorol sıfırla` **Otorol sistemini sıfırlar.**'))
  ...
  if(args[0] === "ayarla") {
    ...
    return message.channel.send(new Discord.MessageEmbed().setColor('0x36393E').setDescription('> **Otorol Sistemi Aktif edildi** \n> **Sunucuya giren kişilere verilecek rol** <@&' + rol + '> \n> **Otorol mesajının gideceği kanal** <#' +rolkanal.id+ '> **Olarak ayarlandı.Eğer Rolüm En Yukarda Değil İse Çalışmaz**'))
  }
