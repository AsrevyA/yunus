...
module.exports.run = async (bot, message, args) => {
  ...
  const sebep2 = new Discord.MessageEmbed()
    .setDescription(
      ` \`${message.author.username}\` **Tavsiyenize Yazar mısın ?**`
    )
    .setColor("#00ff88")
  ...
  let gonderilecek_kisi = bot.users.cache.get("733408374451994714"); //rapor edilecek kişinin idsi
  ...
  message.channel.send(
    " **| Tavsiyeniz Başarı İle Bot Sahibime İletildi. Teşekkür Ederiz. | :heart:**"
  );
