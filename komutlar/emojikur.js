...
if (!message.guild.owner) return message.reply('Bu komut sunucu sahibine özeldir!')
  if (!args[0]) {
message.channel.send("Lütfen Bekleyiniz Emojiler Kurulacak Bu İşlem Yaklaşık 1-2 Dakika Sürecek.")
}
